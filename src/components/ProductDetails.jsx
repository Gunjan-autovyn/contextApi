...
export default function ProductDetails() {
    ...
    useEffect(()=>{
   axios.get(`https://wscubetech.co/ecommerce-api/productdetails.php?id=${params.productId}`)
   .then((sucess)=>{
   setProductDetail(sucess.data.product);
   })
   .catch((error)=>{
          ...
          <div className="py-10 lg:col-span-2 lg:col-start-1 lg:border-r lg:border-gray-200 lg:pb-16 lg:pr-8 lg:pt-6">
            ...
            <div className="mt-10">
              ...
              <div className="mt-4 space-y-6">
                <p className="text-sm text-gray-600">{productDetails.detail}</p>
              </div>
            </div>
          </div>
        </div>
