...
export default function Navbar() {
  ...
  return (
    <header className="bg-white sticky top-0 shadow-black">
      <nav aria-label="Global" className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8">
        ...
        <div className="hidden lg:flex lg:flex-1 lg:justify-end" onClick={()=>cartMenu()}>
          <a  className="cursor-pointer pointer-events-auto rounded-md bg-indigo-600 px-3 py-2 text-[0.8125rem]/5 font-semibold text-white hover:bg-indigo-500" >
